...
int main() {
    // Inicializando la máquina expendedora
    ...
    maquina.productos[0] = {"Hit individual", 2000, 12, true};
    maquina.productos[1] = {"Oreo x 4 undides", 800, 12, false};
    maquina.productos[2] = {"Gansito x unidad", 1800, 12, true};
    maquina.productos[3] = {"SpeedMax litro", 3000, 12, false};
    ...
    do {
        ...
        switch (opcion) {
            ...
            case 7: {
                ...
                numeroMaximo = transaccion.productosComprados[0];
                ...
                cout << "\nEl producto mas comprado es: " << maquina.productos[indice].nombre;
                break;
            }
            case 8: {
            ...
            case 9: {
                for (int i = 0; i < 4; i++) {
                    if (maquina.productos[i].donacionFopre) {
                        cout << "\n\nTipo producto: " << maquina.productos[i].nombre;
                        cout << "\nRecaudo donacion: " << transaccion.valorDonacionProducto[i];
                    }
                }
                break;
            }
